...
namespace Library.WinUI
{
    public partial class frmIssueBooks : Form
    {
        ...
        private void btnSearchMember_Click(object sender, EventArgs e)
        {
            ...
            {
                this.CurrentMemeber = frmsm.SelectedMember;
        ...
        {
            txtIssueNo.Text = new IssueBooksBLL().GetNextSerial().ToString();
        }

        private void btnSave_Click(object sender, EventArgs e)
        {
            ib.IssueDate = dtpIssueDate.Value.Date;
            ib.IssueNumber = Convert.ToInt32(txtIssueNo.Text);
            ib.Member = CurrentMemeber;
            new IssueBooksBLL().SaveIssue(ib);
            MessageBox.Show("Issue Books Saved Successfully!!!", "Issue Books Saved");
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            g.DrawString("Issue Books", SystemFonts.CaptionFont, Brushes.Green, new PointF(100, 10));
        }
    }
}
